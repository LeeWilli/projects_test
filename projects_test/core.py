# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_heart-post-image.ipynb.

# %% auto 0
__all__ = ['video_path', 'video_DIR', 'server_ip', 'hr_server_url', 'send_frame', 'detect_pulse']

# %% ../nbs/02_heart-post-image.ipynb 2
...
# %% ../nbs/02_heart-post-image.ipynb 4
